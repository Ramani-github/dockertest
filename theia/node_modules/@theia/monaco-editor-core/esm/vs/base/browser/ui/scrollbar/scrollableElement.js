...
var MouseWheelClassifier = /** @class */ (function () {
    ...
    MouseWheelClassifier.prototype._isAlmostInt = function (value) {
...
var AbstractScrollableElement = /** @class */ (function (_super) {
    ...
    function AbstractScrollableElement(element, options, scrollable) {
        ...
        _this.onWillScroll = _this._onWillScroll.event;
    ...
    AbstractScrollableElement.prototype.triggerScrollFromMouseWheelEvent = function (browserEvent) {
    ...
    AbstractScrollableElement.prototype._onMouseWheel = function (e) {
        ...
        if (e.deltaY || e.deltaX) {
            ...
            if (this._options.flipAxes) {
                _a = __read([deltaX, deltaY], 2), deltaY = _a[0], deltaX = _a[1];
            }
...
var SmoothScrollableElement = /** @class */ (function (_super) {
    ...
    SmoothScrollableElement.prototype.setScrollPosition = function (update) {
    ...
    SmoothScrollableElement.prototype.getScrollPosition = function () {
        return this._scrollable.getCurrentScrollPosition();
    };
