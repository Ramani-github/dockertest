...
var ObjectTree = /** @class */ (function (_super) {
    ...
    ObjectTree.prototype.setChildren = function (element, children, options) {
    ...
    ObjectTree.prototype.updateElementHeight = function (element, height) {
...
var CompressibleObjectTree = /** @class */ (function (_super) {
    ...
    CompressibleObjectTree.prototype.setChildren = function (element, children, options) {
        if (children === void 0) { children = Iterable.empty(); }
        this.model.setChildren(element, children, options);
    };
