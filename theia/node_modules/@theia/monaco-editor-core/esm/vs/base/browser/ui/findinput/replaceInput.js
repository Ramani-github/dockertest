...
var ReplaceInput = /** @class */ (function (_super) {
    ...
    ReplaceInput.prototype.setFocusInputOnOptionClick = function (value) {
    ...
    ReplaceInput.prototype.clear = function () {
        this.clearValidation();
        this.setValue('');
        this.focus();
    };
    ReplaceInput.prototype.getValue = function () {
        return this.inputBox.value;
    };
    ReplaceInput.prototype.setValue = function (value) {
        if (this.inputBox.value !== value) {
            this.inputBox.value = value;
        }
    };
    ReplaceInput.prototype.onSearchSubmit = function () {
    ...
    ReplaceInput.prototype.highlightFindOptions = function () {
    ...
    ReplaceInput.prototype.showMessage = function (message) {
        if (this.inputBox) {
            this.inputBox.showMessage(message);
        }
    };
    ReplaceInput.prototype.clearMessage = function () {
        if (this.inputBox) {
            this.inputBox.hideMessage();
        }
    };
    ReplaceInput.prototype.clearValidation = function () {
        if (this.inputBox) {
            this.inputBox.hideMessage();
        }
    };
