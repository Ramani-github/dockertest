...
var InputBox = /** @class */ (function (_super) {
    ...
    function InputBox(container, contextViewProvider, options) {
        ...
        _this.onfocus(_this.input, function () { return _this.element.classList.add('synthetic-focus'); });
        _this.onblur(_this.input, function () { return _this.element.classList.remove('synthetic-focus'); });
    ...
    InputBox.prototype.getAriaLabel = function () {
    ...
    InputBox.prototype.isSelectionAtEnd = function () {
    ...
    InputBox.prototype._showMessage = function () {
        ...
        this.contextViewProvider.showContextView({
            ...
            render: function (container) {
                ...
                spanElement.classList.add(_this.classForType(_this.message.type));
