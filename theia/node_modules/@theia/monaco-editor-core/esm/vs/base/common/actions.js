...
export { Separator };
var SubmenuAction = /** @class */ (function () {
    function SubmenuAction(id, label, actions, cssClass) {
        this.tooltip = '';
        this.enabled = true;
        this.checked = false;
        this.id = id;
    ...
    SubmenuAction.prototype.dispose = function () {
        // there is NOTHING to dispose and the SubmenuAction should
        // never have anything to dispose as it is a convenience type
        // to bridge into the rendering world.
    };
    Object.defineProperty(SubmenuAction.prototype, "actions", {
        get: function () {
    ...
    SubmenuAction.prototype.run = function () {
...
var EmptySubmenuAction = /** @class */ (function (_super) {
    __extends(EmptySubmenuAction, _super);
    function EmptySubmenuAction() {
        return _super.call(this, EmptySubmenuAction.ID, nls.localize('submenu.empty', '(empty)'), undefined, false) || this;
    }
