...
var MarkdownString = /** @class */ (function () {
    function MarkdownString(value, isTrustedOrOptions) {
    ...
    MarkdownString.prototype.appendText = function (value, newlineStyle) {
        if (newlineStyle === void 0) { newlineStyle = 0 /* Paragraph */; }
        this.value += escapeMarkdownSyntaxTokens(this.supportThemeIcons ? escapeIcons(value) : value)
            .replace(/([ \t]+)/g, function (_match, g1) { return '&nbsp;'.repeat(g1.length); })
            .replace(/^>/gm, '\\>')
