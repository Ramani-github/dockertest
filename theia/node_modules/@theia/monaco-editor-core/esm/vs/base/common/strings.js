...
export function compareSubstring(a, b, aStart, aEnd, bStart, bEnd) {
...
export function compareSubstringIgnoreCase(a, b, aStart, aEnd, bStart, bEnd) {
    if (aStart === void 0) { aStart = 0; }
    if (aEnd === void 0) { aEnd = a.length; }
    if (bStart === void 0) { bStart = 0; }
    if (bEnd === void 0) { bEnd = b.length; }
...
export var UNUSUAL_LINE_TERMINATORS = /[\u2028\u2029]/; // LINE SEPARATOR (LS) or PARAGRAPH SEPARATOR (PS)
/**
