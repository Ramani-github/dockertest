...
export function anyScore(pattern, lowPattern, _patternPos, word, lowWord, _wordPos) {
    ...
    return __spreadArray([score, _wordPos], __read(matches));
}
//#region --- fuzzyScore ---
...
export function isPatternInWord(patternLow, patternPos, patternLen, wordLow, wordPos, wordLen, fillMinWordPosArr) {
    if (fillMinWordPosArr === void 0) { fillMinWordPosArr = false; }
