...
var FindModelBoundToEditorModel = /** @class */ (function () {
    ...
    FindModelBoundToEditorModel.prototype.research = function (moveCursor, newFindScope) {
        ...
        if (findScopes !== null) {
            findScopes = findScopes.map(function (findScope) {
                if (findScope.startLineNumber !== findScope.endLineNumber) {
                    ...
                    return new Range(findScope.startLineNumber, 1, endLineNumber, _this._editor.getModel().getLineMaxColumn(endLineNumber));
                }
                return findScope;
            });
        }
        ...
        if (currentMatchesPosition === 0 && findMatches.length > 0) {
            ...
            var matchAfterSelection = findFirstInSorted(findMatches.map(function (match) { return match.range; }), function (range) { return Range.compareRangesUsingStarts(range, editorSelection) >= 0; });
    ...
    FindModelBoundToEditorModel.prototype._moveToPrevMatch = function (before, isRecursed) {
        ...
        var prevMatch = model.findPreviousMatch(this._state.searchString, position, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(110 /* wordSeparators */) : null, false);
    ...
    FindModelBoundToEditorModel.prototype._getNextMatch = function (after, captureMatches, forceMove, isRecursed) {
        ...
        var model = this._editor.getModel();
        var position = new Position(lineNumber, column);
        var nextMatch = model.findNextMatch(this._state.searchString, position, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(110 /* wordSeparators */) : null, captureMatches);
    ...
    FindModelBoundToEditorModel.prototype._findMatches = function (findScopes, captureMatches, limitResultCount) {
        var _this = this;
    ...
    FindModelBoundToEditorModel.prototype._largeReplaceAll = function () {
        var searchParams = new SearchParams(this._state.searchString, this._state.isRegex, this._state.matchCase, this._state.wholeWord ? this._editor.getOption(110 /* wordSeparators */) : null);
    ...
    FindModelBoundToEditorModel.prototype._regularReplaceAll = function (findScopes) {
        var replacePattern = this._getReplacePattern();
