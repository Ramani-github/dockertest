...
var FindWidget = /** @class */ (function (_super) {
    ...
    function FindWidget(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService, storageService, notificationService) {
        ...
        _this._register(_this._codeEditor.onDidChangeConfiguration(function (e) {
            if (e.hasChanged(75 /* readOnly */)) {
                if (_this._codeEditor.getOption(75 /* readOnly */)) {
            ...
            if (e.hasChanged(31 /* find */)) {
                var addExtraSpaceOnTop = _this._codeEditor.getOption(31 /* find */).addExtraSpaceOnTop;
        ...
        _this._register(_this._codeEditor.onDidFocusEditorWidget(function () { return __awaiter(_this, void 0, void 0, function () {
            var globalBufferTerm;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this._isVisible) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._controller.getGlobalBufferTerm()];
                    case 1:
                        globalBufferTerm = _a.sent();
        ...
        if (_this._codeEditor.getOption(31 /* find */).addExtraSpaceOnTop) {
        ...
        _this._register(themeService.onDidColorThemeChange(_this._applyTheme.bind(_this)));
    ...
    FindWidget.prototype._updateButtons = function () {
        ...
        var canReplace = !this._codeEditor.getOption(75 /* readOnly */);
    ...
    FindWidget.prototype._layoutViewZone = function (targetScrollTop) {
        var _this = this;
        var addExtraSpaceOnTop = this._codeEditor.getOption(31 /* find */).addExtraSpaceOnTop;
    ...
    FindWidget.prototype._showViewZone = function (adjustScroll) {
        ...
        this._codeEditor.changeViewZones(function (accessor) {
            if (_this._viewZoneId !== undefined) {
                ...
                scrollAdjustment -= _this._codeEditor.getOption(69 /* padding */).top;
    ...
    // ----- sash
    FindWidget.prototype.getVerticalSashLeft = function (_sash) {
        return 0;
    };
    // ----- initialization
        ...
        this._register(this._toggleSelectionFind.onChange(function () {
            if (_this._toggleSelectionFind.checked) {
                if (_this._codeEditor.hasModel()) {
                    ...
                    if (selections.length) {
                        _this._state.change({ searchScope: selections }, true);
                    }
                }
            }
            else {
    ...
    FindWidget.prototype.getViewState = function () {
        var widgetViewZoneVisible = false;
        if (this._viewZone && this._viewZoneId) {
            widgetViewZoneVisible = this._viewZone.heightInPx > this._codeEditor.getScrollTop();
        }
        return {
            widgetViewZoneVisible: widgetViewZoneVisible,
            scrollTop: this._codeEditor.getScrollTop()
        };
    };
    FindWidget.prototype.setViewState = function (state) {
        if (!state) {
            return;
        }
...
var SimpleButton = /** @class */ (function (_super) {
    ...
    function SimpleButton(opts) {
        ...
        if (_this._opts.className) {
            className = className + ' ' + _this._opts.className;
        }
        if (_this._opts.icon) {
            className = className + ' ' + ThemeIcon.asClassName(_this._opts.icon);
        }
    ...
    SimpleButton.prototype.setExpanded = function (expanded) {
        ...
        if (expanded) {
            (_a = this._domNode.classList).remove.apply(_a, __spreadArray([], __read(ThemeIcon.asClassNameArray(findCollapsedIcon))));
            (_b = this._domNode.classList).add.apply(_b, __spreadArray([], __read(ThemeIcon.asClassNameArray(findExpandedIcon))));
        }
        else {
            (_c = this._domNode.classList).remove.apply(_c, __spreadArray([], __read(ThemeIcon.asClassNameArray(findExpandedIcon))));
            (_d = this._domNode.classList).add.apply(_d, __spreadArray([], __read(ThemeIcon.asClassNameArray(findCollapsedIcon))));
        }
    };
    return SimpleButton;
}(Widget));
