...
var DragAndDropController = /** @class */ (function (_super) {
    ...
    function DragAndDropController(editor) {
        ...
        _this._register(_this._editor.onMouseDropCanceled(function () { return _this._onEditorMouseDropCanceled(); }));
        ...
        _this._register(_this._editor.onDidBlurEditorText(function () { return _this.onEditorBlur(); }));
    ...
    DragAndDropController.prototype._onEditorMouseDropCanceled = function () {
        this._editor.updateOptions({
            mouseStyle: 'text'
        });
        this._removeDecoration();
