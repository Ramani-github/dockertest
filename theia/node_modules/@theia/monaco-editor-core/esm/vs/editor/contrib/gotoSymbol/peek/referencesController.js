...
var ReferencesController = /** @class */ (function () {
    ...
    ReferencesController.prototype.toggleWidget = function (range, modelPromise, peekMode) {
        ...
        this._disposables.add(this._widget.onDidClose(function () {
            modelPromise.cancel();
            if (_this._widget) {
                _this._storageService.store(storageKey, JSON.stringify(_this._widget.layoutData), 0 /* GLOBAL */, 1 /* MACHINE */);
            ...
            switch (kind) {
                case 'open':
                    if (event.source !== 'editor' || !_this._configurationService.getValue('editor.stablePeek')) {
                        ...
                        _this.openReference(element, false, false);
                    }
                    break;
                case 'side':
                    _this.openReference(element, true, false);
                    break;
                case 'goto':
                    if (peekMode) {
                        ...
                        _this.openReference(element, false, true);
                    }
                    break;
            }
        }));
        ...
        modelPromise.then(function (model) {
            ...
            (_a = _this._model) === null || _a === void 0 ? void 0 : _a.dispose();
            _this._model = model;
            // show widget
                ...
                if (_this._widget && _this._model && _this._editor.hasModel()) { // might have been closed
                    ...
                    if (selection) {
                        return _this._widget.setSelection(selection).then(function () {
                            if (_this._widget && _this._editor.getOption(71 /* peekWidgetDefaultFocus */) === 'editor') {
    ...
    ReferencesController.prototype.revealReference = function (reference) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._widget.revealReference(reference)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    ReferencesController.prototype.openReference = function (ref, sideBySide, pinned) {
        // clear stage
        if (!sideBySide) {
            this.closeWidget();
        }
        ...
        this._editorService.openCodeEditor({
            resource: uri,
            options: { selection: range, pinned: pinned }
...
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    handler: function (accessor) {
        ...
        if (Array.isArray(focus) && focus[0] instanceof OneReference) {
            withController(accessor, function (controller) { return controller.revealReference(focus[0]); });
        }
    }
});
KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    handler: function (accessor) {
        ...
        var focus = (_a = listService.lastFocusedList) === null || _a === void 0 ? void 0 : _a.getFocus();
        if (Array.isArray(focus) && focus[0] instanceof OneReference) {
            withController(accessor, function (controller) { return controller.openReference(focus[0], true, true); });
        }
    }
});
CommandsRegistry.registerCommand('openReference', function (accessor) {
    ...
    var focus = (_a = listService.lastFocusedList) === null || _a === void 0 ? void 0 : _a.getFocus();
    if (Array.isArray(focus) && focus[0] instanceof OneReference) {
        withController(accessor, function (controller) { return controller.openReference(focus[0], false, true); });
    }
});
