...
import { registerColor, editorSelectionBackground, transparent, iconForeground } from '../../../platform/theme/common/colorRegistry';
...
var FoldingController = /** @class */ (function (_super) {
    ...
    function FoldingController(editor, contextKeyService) {
        ...
        _this._isEnabled = options.get(33 /* folding */);
        _this._useFoldingProviders = options.get(34 /* foldingStrategy */) !== 'indentation';
        _this._unfoldOnClickAfterEndOfLine = options.get(36 /* unfoldOnClickAfterEndOfLine */);
        ...
        _this.foldingDecorationProvider.autoHideFoldingControls = options.get(94 /* showFoldingControls */) === 'mouseover';
        _this.foldingDecorationProvider.showFoldingHighlights = options.get(35 /* foldingHighlight */);
        ...
        _this._register(_this.editor.onDidChangeConfiguration(function (e) {
            if (e.hasChanged(33 /* folding */)) {
                _this._isEnabled = _this.editor.getOptions().get(33 /* folding */);
                _this.foldingEnabled.set(_this._isEnabled);
                _this.onModelChanged();
            }
            if (e.hasChanged(94 /* showFoldingControls */) || e.hasChanged(35 /* foldingHighlight */)) {
                var options_1 = _this.editor.getOptions();
                _this.foldingDecorationProvider.autoHideFoldingControls = options_1.get(94 /* showFoldingControls */) === 'mouseover';
                _this.foldingDecorationProvider.showFoldingHighlights = options_1.get(35 /* foldingHighlight */);
                _this.onModelContentChanged();
            }
            if (e.hasChanged(34 /* foldingStrategy */)) {
                _this._useFoldingProviders = _this.editor.getOptions().get(34 /* foldingStrategy */) !== 'indentation';
                _this.onFoldingStrategyChanged();
            }
            if (e.hasChanged(36 /* unfoldOnClickAfterEndOfLine */)) {
                _this._unfoldOnClickAfterEndOfLine = _this.editor.getOptions().get(36 /* unfoldOnClickAfterEndOfLine */);
            }
        }));
        _this.onModelChanged();
        return _this;
    ...
    FoldingController.prototype.getRangeProvider = function (editorModel) {
        ...
        if (this._useFoldingProviders && this.foldingModel) {
            ...
            if (foldingProviders.length === 0 && this.foldingStateMemento && this.foldingStateMemento.collapsedRegions) {
                ...
                this.rangeProvider = new SyntaxRangeProvider(editorModel, foldingProviders, function () { return _this.onModelContentChanged(); });
            }
        }
                ...
                if (selections && selections.length > 0) {
                    ...
                    var _loop_1 = function (selection) {
                        ...
                        if (_this.hiddenRangeModel && _this.hiddenRangeModel.isHidden(lineNumber)) {
                            toToggle.push.apply(toToggle, __spreadArray([], __read(foldingModel.getAllRegionsAtLine(lineNumber, function (r) { return r.isCollapsed && lineNumber > r.startLineNumber; }))));
                        }
                    };
                    try {
            ...
            if (foldingModel) {
                ...
                if (region && region.startLineNumber === lineNumber) {
                    ...
                    if (iconClicked || isCollapsed) {
                        ...
                        if (recursive) {
                            try {
                                for (var _b = __values(foldingModel.getRegionsInside(region)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    var r = _c.value;
...
export var foldBackgroundBackground = registerColor('editor.foldBackground', { light: transparent(editorSelectionBackground, 0.3), dark: transparent(editorSelectionBackground, 0.3), hc: null }, nls.localize('foldBackgroundBackground', "Background color behind folded ranges. The color must not be opaque so as not to hide underlying decorations."), true);
export var editorFoldForeground = registerColor('editorGutter.foldingControlForeground', { dark: iconForeground, light: iconForeground, hc: iconForeground }, nls.localize('editorGutter.foldingControlForeground', 'Color of the folding control in the editor gutter.'));
