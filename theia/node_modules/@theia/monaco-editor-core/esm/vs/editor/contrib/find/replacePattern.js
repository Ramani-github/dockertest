    ...
    ReplacePattern.prototype.buildReplaceString = function (matches, preserveCase) {
        ...
        for (var i = 0, len = this._state.pieces.length; i < len; i++) {
            ...
            if (piece.caseOps !== null && piece.caseOps.length > 0) {
                ...
                var opIdx = 0;
                for (var idx = 0, len_1 = match.length; idx < len_1; idx++) {
                    if (opIdx >= lenOps) {
...
var ReplacePiece = /** @class */ (function () {
    ...
    ReplacePiece.caseOps = function (index, caseOps) {
...
var ReplacePieceBuilder = /** @class */ (function () {
    ...
    ReplacePieceBuilder.prototype.emitMatchIndex = function (index, toCharIndex, caseOps) {
