...
import { EditorCommand, registerEditorCommand, EditorAction, registerEditorAction } from '../../browser/editorExtensions';
...
var MoveWordCommand = /** @class */ (function (_super) {
    ...
    MoveWordCommand.prototype.runEditorCommand = function (accessor, editor, args) {
        ...
        var wordSeparators = getMapForWordSeparators(editor.getOption(110 /* wordSeparators */));
        ...
        editor._getViewModel().setCursorStates('moveWordCommand', 3 /* Explicit */, result.map(function (r) { return CursorState.fromModelSelection(r); }));
        if (result.length === 1) {
...
var DeleteWordCommand = /** @class */ (function (_super) {
    ...
    DeleteWordCommand.prototype.runEditorCommand = function (accessor, editor, args) {
        ...
        var autoClosingQuotes = editor.getOption(7 /* autoClosingQuotes */);
        var autoClosingPairs = LanguageConfigurationRegistry.getAutoClosingPairs(model.getLanguageIdentifier().id);
...
var DeleteWordLeftCommand = /** @class */ (function (_super) {
    ...
    DeleteWordLeftCommand.prototype._delete = function (ctx, wordNavigationType) {
        var r = WordOperations.deleteWordLeft(ctx, wordNavigationType);
        if (r) {
            return r;
        }
...
var DeleteWordRightCommand = /** @class */ (function (_super) {
    ...
    DeleteWordRightCommand.prototype._delete = function (ctx, wordNavigationType) {
        var r = WordOperations.deleteWordRight(ctx, wordNavigationType);
        if (r) {
            return r;
        }
...
var DeleteInsideWord = /** @class */ (function (_super) {
    __extends(DeleteInsideWord, _super);
    ...
    DeleteInsideWord.prototype.run = function (accessor, editor, args) {
        if (!editor.hasModel()) {
            return;
        }
        var wordSeparators = getMapForWordSeparators(editor.getOption(110 /* wordSeparators */));
        ...
        var selections = editor.getSelections();
        var commands = selections.map(function (sel) {
            var deleteRange = WordOperations.deleteInsideWord(wordSeparators, model, sel);
            return new ReplaceCommand(deleteRange, '');
        });
        editor.pushUndoStop();
        editor.executeCommands(this.id, commands);
