...
CommandsRegistry.registerCommand({
    ...
    handler: function (accessor, resource, position, references, multiple, noResultsMessage, openInPeek) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    if (isCodeEditor(editor)) {
                        ...
                        return [2 /*return*/, editor.invokeWithinContext(function (accessor) {
                                var command = new /** @class */ (function (_super) {
                                    ...
                                    class_1.prototype._getNoResultFoundMessage = function (info) {
                                        return noResultsMessage || _super.prototype._getNoResultFoundMessage.call(this, info);
                                    };
                                    return class_1;
