...
var ClickLinkGesture = /** @class */ (function (_super) {
    ...
    function ClickLinkGesture(editor) {
        ...
        _this._opts = createOptions(_this._editor.getOption(64 /* multiCursorModifier */));
        ...
        _this._register(_this._editor.onDidChangeConfiguration(function (e) {
            if (e.hasChanged(64 /* multiCursorModifier */)) {
                var newOpts = createOptions(_this._editor.getOption(64 /* multiCursorModifier */));
        ...
        _this._register(_this._editor.onMouseMove(function (e) { return _this._onEditorMouseMove(new ClickLinkMouseEvent(e, _this._opts)); }));
        _this._register(_this._editor.onMouseDown(function (e) { return _this._onEditorMouseDown(new ClickLinkMouseEvent(e, _this._opts)); }));
        _this._register(_this._editor.onMouseUp(function (e) { return _this._onEditorMouseUp(new ClickLinkMouseEvent(e, _this._opts)); }));
        _this._register(_this._editor.onKeyDown(function (e) { return _this._onEditorKeyDown(new ClickLinkKeyboardEvent(e, _this._opts)); }));
        _this._register(_this._editor.onKeyUp(function (e) { return _this._onEditorKeyUp(new ClickLinkKeyboardEvent(e, _this._opts)); }));
        _this._register(_this._editor.onMouseDrag(function () { return _this._resetHandler(); }));
        _this._register(_this._editor.onDidChangeCursorSelection(function (e) { return _this._onDidChangeCursorSelection(e); }));
        _this._register(_this._editor.onDidChangeModel(function (e) { return _this._resetHandler(); }));
        _this._register(_this._editor.onDidChangeModelContent(function () { return _this._resetHandler(); }));
    ...
    ClickLinkGesture.prototype._onDidChangeCursorSelection = function (e) {
        if (e.selection && e.selection.startColumn !== e.selection.endColumn) {
            this._resetHandler(); // immediately stop this feature if the user starts to select (https://github.com/microsoft/vscode/issues/7827)
        }
    };
    ClickLinkGesture.prototype._onEditorMouseMove = function (mouseEvent) {
        this._lastMouseMoveEvent = mouseEvent;
        this._onMouseMoveOrRelevantKeyDown.fire([mouseEvent, null]);
    };
    ClickLinkGesture.prototype._onEditorMouseDown = function (mouseEvent) {
    ...
    ClickLinkGesture.prototype._onEditorMouseUp = function (mouseEvent) {
        var currentLineNumber = mouseEvent.target.position ? mouseEvent.target.position.lineNumber : 0;
        if (this._hasTriggerKeyOnMouseDown && this._lineNumberOnMouseDown && this._lineNumberOnMouseDown === currentLineNumber) {
            this._onExecute.fire(mouseEvent);
        }
    };
    ClickLinkGesture.prototype._onEditorKeyDown = function (e) {
    ...
    ClickLinkGesture.prototype._onEditorKeyUp = function (e) {
        if (e.keyCodeIsTriggerKey) {
            this._onCancel.fire();
        }
    };
    ClickLinkGesture.prototype._resetHandler = function () {
