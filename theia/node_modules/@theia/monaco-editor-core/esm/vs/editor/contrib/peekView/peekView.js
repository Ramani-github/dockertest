...
var PeekViewWidget = /** @class */ (function (_super) {
    ...
    function PeekViewWidget(editor, options, instantiationService) {
    ...
    PeekViewWidget.prototype._fillHead = function (container, noCloseAction) {
        var _this = this;
        ...
        if (!noCloseAction) {
            this._actionbarWidget.push(new Action('peekview.close', nls.localize('label.close', "Close"), Codicon.close.classNames, true, function () {
                _this.dispose();
    ...
    PeekViewWidget.prototype._doLayout = function (heightInPixel, widthInPixel) {
        ...
        var headHeight = Math.ceil(this.editor.getOption(53 /* lineHeight */) * 1.2);
