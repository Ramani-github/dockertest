...
var Marker = /** @class */ (function () {
    ...
    Marker.prototype.replace = function (child, others) {
        ...
        newChildren.splice.apply(newChildren, __spreadArray([idx, 1], __read(others)));
...
function walk(marker, visitor) {
    var stack = __spreadArray([], __read(marker));
    while (stack.length > 0) {
        ...
        stack.unshift.apply(stack, __spreadArray([], __read(marker_1.children)));
    }
}
...
var SnippetParser = /** @class */ (function () {
    ...
    SnippetParser.guessNeedsClipboard = function (template) {
    ...
    SnippetParser.prototype.parse = function (value, insertFinalTabstop, enforceFinalTabstop) {
        ...
        try {
            for (var incompletePlaceholders_1 = __values(incompletePlaceholders), incompletePlaceholders_1_1 = incompletePlaceholders_1.next(); !incompletePlaceholders_1_1.done; incompletePlaceholders_1_1 = incompletePlaceholders_1.next()) {
                var placeholder = incompletePlaceholders_1_1.value;
                var defaultValues = placeholderDefaultValues.get(placeholder.index);
                if (defaultValues) {
                    var clone = new Placeholder(placeholder.index);
                    clone.transform = placeholder.transform;
                    try {
                        for (var defaultValues_1 = (e_4 = void 0, __values(defaultValues)), defaultValues_1_1 = defaultValues_1.next(); !defaultValues_1_1.done; defaultValues_1_1 = defaultValues_1.next()) {
                            var child = defaultValues_1_1.value;
                        ...
                        try {
                            if (defaultValues_1_1 && !defaultValues_1_1.done && (_b = defaultValues_1.return)) _b.call(defaultValues_1);
                        }
            ...
            try {
                if (incompletePlaceholders_1_1 && !incompletePlaceholders_1_1.done && (_a = incompletePlaceholders_1.return)) _a.call(incompletePlaceholders_1);
            }
