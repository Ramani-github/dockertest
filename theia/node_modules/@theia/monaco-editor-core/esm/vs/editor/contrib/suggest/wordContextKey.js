...
var WordContextKey = /** @class */ (function () {
    function WordContextKey(_editor, contextKeyService) {
        ...
        this._configListener = this._editor.onDidChangeConfiguration(function (e) { return e.hasChanged(106 /* tabCompletion */) && _this._update(); });
        this._update();
    }
    ...
    WordContextKey.prototype._update = function () {
        ...
        var enabled = this._editor.getOption(106 /* tabCompletion */) === 'on';
