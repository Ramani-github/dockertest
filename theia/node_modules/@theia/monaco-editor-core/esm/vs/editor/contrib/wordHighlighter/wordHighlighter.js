...
var WordHighlighter = /** @class */ (function () {
    function WordHighlighter(editor, contextKeyService) {
        ...
        this.toUnhook.add(editor.onDidChangeConfiguration(function (e) {
            var newValue = _this.editor.getOption(66 /* occurrencesHighlight */);
    ...
    WordHighlighter.prototype.moveNext = function () {
        ...
        var index = highlights.findIndex(function (range) { return range.containsPosition(_this.editor.getPosition()); });
    ...
    WordHighlighter.prototype._getWord = function () {
    ...
    WordHighlighter.prototype.renderDecorations = function () {
        ...
        var decorations = [];
        try {
            for (var _b = __values(this.workerRequestValue), _c = _b.next(); !_c.done; _c = _b.next()) {
                var info = _c.value;
                if (info.range) {
                    decorations.push({
                        range: info.range,
...
var WordHighlighterContribution = /** @class */ (function (_super) {
    ...
    function WordHighlighterContribution(editor, contextKeyService) {
        ...
        var createWordHighlighterIfPossible = function () {
            if (editor.hasModel()) {
                _this.wordHighlighter = new WordHighlighter(editor, contextKeyService);
            }
        };
