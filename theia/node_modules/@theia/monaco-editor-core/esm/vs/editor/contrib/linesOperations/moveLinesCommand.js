...
var MoveLinesCommand = /** @class */ (function () {
        ...
        if (s.startLineNumber === s.endLineNumber && model.getLineMaxColumn(s.startLineNumber) === 1) {
            ...
            if (this._isMovingDown) {
                ...
                if (this.shouldAutoIndent(model, s)) {
                    ...
                    var ret = this.matchEnterRuleMovingDown(model, indentConverter, tabSize, s.startLineNumber, movingLineNumber_1, insertingText_1);
    ...
    MoveLinesCommand.prototype.parseEnterResult = function (model, indentConverter, tabSize, line, enter) {
        if (enter) {
     ...
     */
    MoveLinesCommand.prototype.matchEnterRuleMovingDown = function (model, indentConverter, tabSize, line, futureAboveLineNumber, futureAboveLineText) {
        if (strings.lastNonWhitespaceIndex(futureAboveLineText) >= 0) {
            // break
            var maxColumn = model.getLineMaxColumn(futureAboveLineNumber);
            var enter = LanguageConfigurationRegistry.getEnterAction(this._autoIndent, model, new Range(futureAboveLineNumber, maxColumn, futureAboveLineNumber, maxColumn));
    ...
    MoveLinesCommand.prototype.matchEnterRule = function (model, indentConverter, tabSize, line, oneLineAbove, previousLineText) {
