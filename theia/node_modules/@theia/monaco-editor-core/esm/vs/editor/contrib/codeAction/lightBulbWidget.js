...
import { editorLightBulbForeground, editorLightBulbAutoFixForeground, editorBackground } from '../../../platform/theme/common/colorRegistry';
...
var LightBulbWidget = /** @class */ (function (_super) {
    ...
    function LightBulbWidget(_editor, _quickFixActionId, _preferredFixActionId, _keybindingService) {
        ...
        _this._domNode.className = Codicon.lightBulb.classNames;
        ...
        _this._register(dom.addStandardDisposableGenericMouseDownListner(_this._domNode, function (e) {
            ...
            var lineHeight = _this._editor.getOption(53 /* lineHeight */);
        ...
        _this._register(_this._editor.onDidChangeConfiguration(function (e) {
            ...
            if (e.hasChanged(51 /* lightbulb */) && !_this._editor.getOption(51 /* lightbulb */).enabled) {
                _this.hide();
            }
        }));
        _this._updateLightBulbTitleAndIcon();
        _this._register(_this._keybindingService.onDidUpdateKeybindings(_this._updateLightBulbTitleAndIcon, _this));
        return _this;
    }
    ...
    LightBulbWidget.prototype.update = function (actions, trigger, atPosition) {
        ...
        var _a = model.validatePosition(atPosition), lineNumber = _a.lineNumber, column = _a.column;
    ...
    LightBulbWidget.prototype._updateLightBulbTitleAndIcon = function () {
        var _a, _b, _c, _d;
        if (this.state.type === 1 /* Showing */ && this.state.actions.hasAutoFix) {
            // update icon
            (_a = this._domNode.classList).remove.apply(_a, __spreadArray([], __read(Codicon.lightBulb.classNamesArray)));
            (_b = this._domNode.classList).add.apply(_b, __spreadArray([], __read(Codicon.lightbulbAutofix.classNamesArray)));
        ...
        // update icon
        (_c = this._domNode.classList).remove.apply(_c, __spreadArray([], __read(Codicon.lightbulbAutofix.classNamesArray)));
        (_d = this._domNode.classList).add.apply(_d, __spreadArray([], __read(Codicon.lightBulb.classNamesArray)));
...
registerThemingParticipant(function (theme, collector) {
    var _a;
    var editorBackgroundColor = (_a = theme.getColor(editorBackground)) === null || _a === void 0 ? void 0 : _a.transparent(0.7);
    // Lightbulb Icon
