...
var MultiCursorSession = /** @class */ (function () {
    ...
    MultiCursorSession.prototype._getNextMatch = function () {
        ...
        var nextMatch = this._editor.getModel().findNextMatch(this.searchText, lastAddedSelection.getEndPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(110 /* wordSeparators */) : null, false);
        if (!nextMatch) {
            return null;
        }
    ...
    MultiCursorSession.prototype._getPreviousMatch = function () {
        ...
        var allSelections = this._editor.getSelections();
        var lastAddedSelection = allSelections[allSelections.length - 1];
        var previousMatch = this._editor.getModel().findPreviousMatch(this.searchText, lastAddedSelection.getStartPosition(), false, this.matchCase, this.wholeWord ? this._editor.getOption(110 /* wordSeparators */) : null, false);
        if (!previousMatch) {
            return null;
        }
...
var MultiCursorSelectionController = /** @class */ (function (_super) {
    ...
    MultiCursorSelectionController.prototype.selectAll = function (findController) {
        ...
        if (findState.searchScope) {
            var states_1 = findState.searchScope;
            var inSelection_1 = [];
            matches.forEach(function (match) {
                states_1.forEach(function (state) {
                    if (match.range.endLineNumber <= state.endLineNumber && match.range.startLineNumber >= state.startLineNumber) {
                        inSelection_1.push(match);
                    }
                });
            });
            matches = inSelection_1;
        }
        if (matches.length > 0) {
    ...
    MultiCursorSelectionController.prototype.selectAllUsingSelections = function (selections) {
...
var SelectionHighlighterState = /** @class */ (function () {
    function SelectionHighlighterState(searchText, matchCase, wordSeparators, modelVersionId) {
        this.searchText = searchText;
        this.matchCase = matchCase;
...
var SelectionHighlighter = /** @class */ (function (_super) {
    ...
    function SelectionHighlighter(editor) {
        var _this = _super.call(this) || this;
        _this.editor = editor;
        _this._isEnabled = editor.getOption(92 /* selectionHighlight */);
        _this.decorations = [];
    ...
    SelectionHighlighter.prototype._setState = function (state) {
        ...
        var hasFindOccurrences = DocumentHighlightProviderRegistry.has(model) && this.editor.getOption(66 /* occurrencesHighlight */);
