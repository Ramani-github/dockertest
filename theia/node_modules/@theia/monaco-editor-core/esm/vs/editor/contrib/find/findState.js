...
var FindReplaceState = /** @class */ (function (_super) {
    ...
    FindReplaceState.prototype.change = function (newState, moveCursor, updateHistory) {
        ...
        if (typeof newState.searchScope !== 'undefined') {
            if (!((_a = newState.searchScope) === null || _a === void 0 ? void 0 : _a.every(function (newSearchScope) {
                var _a;
    ...
    FindReplaceState.prototype.canNavigateBack = function () {
        return this.canNavigateInLoop() || (this.matchesPosition !== 1);
    };
    FindReplaceState.prototype.canNavigateForward = function () {
        return this.canNavigateInLoop() || (this.matchesPosition < this.matchesCount);
    };
    FindReplaceState.prototype.canNavigateInLoop = function () {
