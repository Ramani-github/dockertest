...
var AbstractLineHighlightOverlay = /** @class */ (function (_super) {
    ...
    function AbstractLineHighlightOverlay(context) {
        ...
        _this._renderLineHighlight = options.get(80 /* renderLineHighlight */);
        _this._renderLineHighlightOnlyWhenFocus = options.get(81 /* renderLineHighlightOnlyWhenFocus */);
    ...
    AbstractLineHighlightOverlay.prototype.onFocusChanged = function (e) {
...
var CurrentLineMarginHighlightOverlay = /** @class */ (function (_super) {
    ...
    CurrentLineMarginHighlightOverlay.prototype._shouldRenderMargin = function () {
        return ((this._renderLineHighlight === 'gutter' || this._renderLineHighlight === 'all')
            && (!this._renderLineHighlightOnlyWhenFocus || this._focused));
    };
