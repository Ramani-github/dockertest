...
var InlineDiffMargin = /** @class */ (function (_super) {
    ...
    function InlineDiffMargin(_viewZoneId, _marginDomNode, editor, diff, _contextMenuService, _clipboardService) {
        ...
        var lineHeight = editor.getOption(53 /* lineHeight */);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._clipboardService.writeText(deletedText)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this._clipboardService.writeText(lineContent)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        var readOnly = editor.getOption(75 /* readOnly */);
        if (!readOnly) {
            actions.push(new Action('diff.inline.revertChange', nls.localize('diff.inline.revertChange.label', "Revert this change"), undefined, true, function () { return __awaiter(_this, void 0, void 0, function () {
                var range, deletedText, column, column;
                return __generator(this, function (_a) {
