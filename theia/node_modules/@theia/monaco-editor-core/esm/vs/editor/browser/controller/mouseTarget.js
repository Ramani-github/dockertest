...
var HitTestContext = /** @class */ (function () {
    ...
    HitTestContext.prototype.isInTopPadding = function (mouseVerticalOffset) {
        return this._context.viewLayout.isInTopPadding(mouseVerticalOffset);
    };
    HitTestContext.prototype.isInBottomPadding = function (mouseVerticalOffset) {
...
var MouseTargetFactory = /** @class */ (function () {
    ...
    MouseTargetFactory._hitTestViewCursor = function (ctx, request) {
        ...
        if (request.target) {
            ...
            try {
                for (var lastViewCursorsRenderData_1 = __values(lastViewCursorsRenderData), lastViewCursorsRenderData_1_1 = lastViewCursorsRenderData_1.next(); !lastViewCursorsRenderData_1_1.done; lastViewCursorsRenderData_1_1 = lastViewCursorsRenderData_1.next()) {
                    var d = lastViewCursorsRenderData_1_1.value;
                ...
                try {
                    if (lastViewCursorsRenderData_1_1 && !lastViewCursorsRenderData_1_1.done && (_a = lastViewCursorsRenderData_1.return)) _a.call(lastViewCursorsRenderData_1);
                }
        ...
        if (request.isInContentArea) {
            ...
            try {
                for (var lastViewCursorsRenderData_2 = __values(lastViewCursorsRenderData), lastViewCursorsRenderData_2_1 = lastViewCursorsRenderData_2.next(); !lastViewCursorsRenderData_2_1.done; lastViewCursorsRenderData_2_1 = lastViewCursorsRenderData_2.next()) {
                    var d = lastViewCursorsRenderData_2_1.value;
                ...
                try {
                    if (lastViewCursorsRenderData_2_1 && !lastViewCursorsRenderData_2_1.done && (_b = lastViewCursorsRenderData_2.return)) _b.call(lastViewCursorsRenderData_2);
                }
    ...
    MouseTargetFactory._doHitTestWithCaretPositionFromPoint = function (ctx, coords) {
        ...
        if (hitResult.offsetNode.nodeType === hitResult.offsetNode.ELEMENT_NODE) {
            var parent1 = hitResult.offsetNode.parentNode;
            var parent1ClassName = parent1 && parent1.nodeType === parent1.ELEMENT_NODE ? parent1.className : null;
            ...
            if (parent1ClassName === ViewLine.CLASS_NAME) {
                ...
                if (tokenSpan) {
                    var p = ctx.getPositionFromDOMInfo(tokenSpan, 0);
                    return {
                        position: p,
                        hitTarget: null
                    };
                ...
                var p = ctx.getPositionFromDOMInfo(hitResult.offsetNode, 0);
                return {
                    position: p,
                    hitTarget: null
                };
    ...
    MouseTargetFactory._snapToSoftTabBoundary = function (position, viewModel) {
        var lineContent = viewModel.getLineContent(position.lineNumber);
        var tabSize = viewModel.getTextModelOptions().tabSize;
        var newPosition = AtomicTabMoveOperations.atomicPosition(lineContent, position.column - 1, tabSize, 2 /* Nearest */);
        if (newPosition !== -1) {
