...
var HorizontalRevealRangeRequest = /** @class */ (function () {
    function HorizontalRevealRangeRequest(lineNumber, startColumn, endColumn, startScrollTop, stopScrollTop, scrollType) {
    ...
    return HorizontalRevealRangeRequest;
}());
var HorizontalRevealSelectionsRequest = /** @class */ (function () {
    function HorizontalRevealSelectionsRequest(selections, startScrollTop, stopScrollTop, scrollType) {
    ...
    return HorizontalRevealSelectionsRequest;
}());
var ViewLines = /** @class */ (function (_super) {
    ...
    function ViewLines(context, linesContent) {
        ...
        _this._lineHeight = options.get(53 /* lineHeight */);
        ...
        _this._revealHorizontalRightPadding = options.get(84 /* revealHorizontalRightPadding */);
        _this._cursorSurroundingLines = options.get(22 /* cursorSurroundingLines */);
        _this._cursorSurroundingLinesStyle = options.get(23 /* cursorSurroundingLinesStyle */);
        _this._canUseLayerHinting = !options.get(25 /* disableLayerHinting */);
        ...
        _this.domNode.setClassName("view-lines " + MOUSE_CURSOR_TEXT_CSS_CLASS_NAME);
    ...
    ViewLines.prototype.onRevealRangeRequest = function (e) {
        ...
        var scrollType = (scrollTopDelta <= this._lineHeight ? 1 /* Immediate */ : e.scrollType);
    ...
    ViewLines.prototype._checkMonospaceFontAssumptions = function () {
    ...
    ViewLines.prototype._computeScrollTopToRevealRange = function (viewport, source, range, selections, verticalType) {
    ...
    ViewLines.prototype._computeScrollLeftToReveal = function (horizontalRevealRequest) {
        ...
        if (horizontalRevealRequest.type === 'range') {
            ...
            try {
                for (var _d = __values(visibleRanges.ranges), _e = _d.next(); !_e.done; _e = _d.next()) {
            ...
            try {
                for (var _f = __values(horizontalRevealRequest.selections), _g = _f.next(); !_g.done; _g = _f.next()) {
                    var selection = _g.value;
                    if (selection.startLineNumber !== selection.endLineNumber) {
                        return null;
                    }
                    var visibleRanges = this._visibleRangesForLineRange(selection.startLineNumber, selection.startColumn, selection.endColumn);
                    if (!visibleRanges) {
                        return null;
                    }
                    try {
                        for (var _h = (e_3 = void 0, __values(visibleRanges.ranges)), _j = _h.next(); !_j.done; _j = _h.next()) {
                            var visibleRange = _j.value;
                            boxStartX = Math.min(boxStartX, visibleRange.left);
                            boxEndX = Math.max(boxEndX, visibleRange.left + visibleRange.width);
                        }
                    }
