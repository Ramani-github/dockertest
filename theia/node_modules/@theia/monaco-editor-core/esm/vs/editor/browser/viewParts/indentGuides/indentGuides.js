...
var IndentGuidesOverlay = /** @class */ (function (_super) {
    ...
    function IndentGuidesOverlay(context) {
        ...
        _this._enabled = options.get(78 /* renderIndentGuides */);
        _this._activeIndentEnabled = options.get(47 /* highlightActiveIndentGuide */);
    ...
    IndentGuidesOverlay.prototype.prepareRender = function (ctx) {
        ...
        var indentSize = this._context.model.getTextModelOptions().indentSize;
