...
var EditorScrollbar = /** @class */ (function (_super) {
    ...
    function EditorScrollbar(context, linesContent, viewDomNode, overflowGuardDomNode) {
        ...
        var scrollbar = options.get(87 /* scrollbar */);
        var mouseWheelScrollSensitivity = options.get(61 /* mouseWheelScrollSensitivity */);
        var fastScrollSensitivity = options.get(30 /* fastScrollSensitivity */);
        var scrollPredominantAxis = options.get(90 /* scrollPredominantAxis */);
        ...
        var onBrowserDesperateReveal = function (domNode, lookAtScrollTop, lookAtScrollLeft) {
            ...
            _this._context.model.setScrollPosition(newScrollPosition, 1 /* Immediate */);
        };
    ...
    EditorScrollbar.prototype._setLayout = function () {
        ...
        var minimap = options.get(59 /* minimap */);
