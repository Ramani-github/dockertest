...
var RefCountedStyleSheet = /** @class */ (function () {
    ...
    Object.defineProperty(RefCountedStyleSheet.prototype, "sheet", {
        get: function () {
    ...
    RefCountedStyleSheet.prototype.insertRule = function (rule, index) {
        var sheet = this._styleSheet.sheet;
        sheet.insertRule(rule, index);
    };
    RefCountedStyleSheet.prototype.removeRulesContainingSelector = function (ruleName) {
        dom.removeCSSRulesContainingSelector(ruleName, this._styleSheet);
    };
    return RefCountedStyleSheet;
}());
export { RefCountedStyleSheet };
var GlobalStyleSheet = /** @class */ (function () {
    function GlobalStyleSheet(styleSheet) {
        this._styleSheet = styleSheet;
    }
    Object.defineProperty(GlobalStyleSheet.prototype, "sheet", {
        get: function () {
            return this._styleSheet.sheet;
        },
        enumerable: false,
    ...
    GlobalStyleSheet.prototype.insertRule = function (rule, index) {
        var sheet = this._styleSheet.sheet;
        sheet.insertRule(rule, index);
    };
    GlobalStyleSheet.prototype.removeRulesContainingSelector = function (ruleName) {
        dom.removeCSSRulesContainingSelector(ruleName, this._styleSheet);
    };
...
var CodeEditorServiceImpl = /** @class */ (function (_super) {
    ...
    function CodeEditorServiceImpl(styleSheet, themeService) {
    ...
    CodeEditorServiceImpl.prototype.resolveDecorationCSSRules = function (decorationTypeKey) {
        var provider = this._decorationOptionProviders.get(decorationTypeKey);
        if (!provider) {
            return null;
        }
...
var DecorationSubTypeOptionsProvider = /** @class */ (function () {
    ...
    DecorationSubTypeOptionsProvider.prototype.resolveDecorationCSSRules = function () {
...
export { DecorationSubTypeOptionsProvider };
var DecorationTypeOptionsProvider = /** @class */ (function () {
    ...
    DecorationTypeOptionsProvider.prototype.resolveDecorationCSSRules = function () {
...
export { DecorationTypeOptionsProvider };
var _CSS_MAP = {
    ...
    function DecorationCSSRules(ruleType, providerArgs, themeService) {
        ...
        if (this._usesThemeColors) {
            this._themeListener = themeService.onDidColorThemeChange(function (theme) {
                _this._theme = themeService.getColorTheme();
                _this._removeCSS();
                _this._buildCSS();
            });
        }
