...
var MouseHandler = /** @class */ (function (_super) {
    ...
    function MouseHandler(context, viewController, viewHelper) {
        ...
        _this._height = _this._context.configuration.options.get(124 /* layoutInfo */).height;
        ...
        var onMouseWheel = function (browserEvent) {
            ...
            if (!_this._context.configuration.options.get(62 /* mouseWheelZoom */)) {
                return;
            }
            var e = new StandardWheelEvent(browserEvent);
            var doMouseWheelZoom = (platform.isMacintosh
        ...
        _this._register(dom.addDisposableListener(_this.viewHelper.viewDomNode, dom.EventType.MOUSE_WHEEL, onMouseWheel, { capture: true, passive: false }));
    ...
    MouseHandler.prototype.onConfigurationChanged = function (e) {
        if (e.hasChanged(124 /* layoutInfo */)) {
            // layout change
            var height = this._context.configuration.options.get(124 /* layoutInfo */).height;
    ...
    MouseHandler.prototype._onMouseDown = function (e) {
        ...
        var selectOnLineNumbers = this._context.configuration.options.get(93 /* selectOnLineNumbers */);
    ...
    MouseHandler.prototype._onMouseWheel = function (e) {
...
var MouseDownOperation = /** @class */ (function (_super) {
    ...
    MouseDownOperation.prototype.start = function (targetType, e) {
        ...
        if (!options.get(75 /* readOnly */)
            ...
            this._isActive = true;
            this._mouseMoveMonitor.startMonitoring(e.target, e.buttons, createMouseMoveEventMerger(null), function (e) { return _this._onMouseDownThenMove(e); }, function (browserEvent) {
                var position = _this._findMousePosition(_this._lastMouseEvent, true);
                if (browserEvent && browserEvent instanceof KeyboardEvent) {
                    // cancel
                    _this._viewController.emitMouseDropCanceled();
                }
                else {
    ...
    MouseDownOperation.prototype.onHeightChanged = function () {
