...
var ViewCursors = /** @class */ (function (_super) {
    ...
    function ViewCursors(context) {
        ...
        _this._readOnly = options.get(75 /* readOnly */);
        _this._cursorBlinking = options.get(19 /* cursorBlinking */);
        _this._cursorStyle = options.get(21 /* cursorStyle */);
        _this._cursorSmoothCaretAnimation = options.get(20 /* cursorSmoothCaretAnimation */);
    ...
    ViewCursors.prototype.onCompositionStart = function (e) {
        this._isComposingInput = true;
        this._updateBlinking();
        return true;
    };
    ViewCursors.prototype.onCompositionEnd = function (e) {
    ...
    ViewCursors.prototype.onTokensChanged = function (e) {
        ...
        try {
            for (var _b = __values(this._secondaryCursors), _c = _b.next(); !_c.done; _c = _b.next()) {
                var secondaryCursor = _c.value;
