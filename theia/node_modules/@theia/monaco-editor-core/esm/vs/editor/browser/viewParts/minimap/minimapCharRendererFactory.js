...
var MinimapCharRendererFactory = /** @class */ (function () {
    ...
    MinimapCharRendererFactory.createSampleData = function (fontFamily) {
        ...
        var x = 0;
        try {
            for (var allCharCodes_1 = __values(allCharCodes), allCharCodes_1_1 = allCharCodes_1.next(); !allCharCodes_1_1.done; allCharCodes_1_1 = allCharCodes_1.next()) {
                var code = allCharCodes_1_1.value;
            ...
            try {
                if (allCharCodes_1_1 && !allCharCodes_1_1.done && (_a = allCharCodes_1.return)) _a.call(allCharCodes_1);
            }
