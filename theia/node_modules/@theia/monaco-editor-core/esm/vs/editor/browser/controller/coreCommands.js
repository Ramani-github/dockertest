...
var EditorOrNativeTextInputCommand = /** @class */ (function () {
    ...
    EditorOrNativeTextInputCommand.prototype._runEditorCommand = function (accessor, editor, args) {
...
(function (CoreNavigationCommands) {
    var BaseMoveToCommand = /** @class */ (function (_super) {
        ...
        BaseMoveToCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
    ...
    var ColumnSelectCommand = /** @class */ (function (_super) {
        ...
        ColumnSelectCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            ...
            viewModel.setCursorStates(args.source, 3 /* Explicit */, result.viewStates.map(function (viewState) { return CursorState.fromViewState(viewState); }));
    ...
    CoreNavigationCommands.ColumnSelect = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_1.prototype._getColumnSelectResult = function (viewModel, primary, prevColumnSelectData, args) {
            // validate `args`
    ...
    CoreNavigationCommands.CursorColumnSelectLeft = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_2.prototype._getColumnSelectResult = function (viewModel, primary, prevColumnSelectData, args) {
    ...
    CoreNavigationCommands.CursorColumnSelectRight = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_3.prototype._getColumnSelectResult = function (viewModel, primary, prevColumnSelectData, args) {
    ...
    var ColumnSelectUpCommand = /** @class */ (function (_super) {
        ...
        ColumnSelectUpCommand.prototype._getColumnSelectResult = function (viewModel, primary, prevColumnSelectData, args) {
    ...
    var ColumnSelectDownCommand = /** @class */ (function (_super) {
        ...
        ColumnSelectDownCommand.prototype._getColumnSelectResult = function (viewModel, primary, prevColumnSelectData, args) {
    ...
    var CursorMoveImpl = /** @class */ (function (_super) {
        ...
        CursorMoveImpl.prototype.runCoreEditorCommand = function (viewModel, args) {
        ...
        CursorMoveImpl.prototype._runCursorMove = function (viewModel, source, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(source, 3 /* Explicit */, CursorMoveImpl._move(viewModel, viewModel.getCursorStates(), args));
            viewModel.revealPrimaryCursor(source, true);
        };
        CursorMoveImpl._move = function (viewModel, cursors, args) {
    ...
    var CursorMoveBasedCommand = /** @class */ (function (_super) {
        ...
        CursorMoveBasedCommand.prototype.runCoreEditorCommand = function (viewModel, dynamicArgs) {
    ...
    CoreNavigationCommands.CreateCursor = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_4.prototype.runCoreEditorCommand = function (viewModel, args) {
            var newState;
            if (args.wholeLine) {
    ...
    CoreNavigationCommands.LastCursorMoveToSelect = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_5.prototype.runCoreEditorCommand = function (viewModel, args) {
    ...
    var HomeCommand = /** @class */ (function (_super) {
        ...
        HomeCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
    ...
    var LineStartCommand = /** @class */ (function (_super) {
        __extends(LineStartCommand, _super);
        function LineStartCommand(opts) {
            var _this = _super.call(this, opts) || this;
            _this._inSelectionMode = opts.inSelectionMode;
            return _this;
        }
        LineStartCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, this._exec(viewModel.getCursorStates()));
            viewModel.revealPrimaryCursor(args.source, true);
        };
        LineStartCommand.prototype._exec = function (cursors) {
            var result = [];
    ...
    var EndCommand = /** @class */ (function (_super) {
        ...
        EndCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
    ...
    var LineEndCommand = /** @class */ (function (_super) {
        __extends(LineEndCommand, _super);
        function LineEndCommand(opts) {
            var _this = _super.call(this, opts) || this;
            _this._inSelectionMode = opts.inSelectionMode;
            return _this;
        }
        LineEndCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, this._exec(viewModel, viewModel.getCursorStates()));
            viewModel.revealPrimaryCursor(args.source, true);
        };
        LineEndCommand.prototype._exec = function (viewModel, cursors) {
            var result = [];
            for (var i = 0, len = cursors.length; i < len; i++) {
                var cursor = cursors[i];
                var lineNumber = cursor.modelState.position.lineNumber;
    ...
    var TopCommand = /** @class */ (function (_super) {
        ...
        TopCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
    ...
    var BottomCommand = /** @class */ (function (_super) {
        ...
        BottomCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
    ...
    var EditorScrollImpl = /** @class */ (function (_super) {
        ...
        EditorScrollImpl.prototype.runCoreEditorCommand = function (viewModel, args) {
        ...
        EditorScrollImpl.prototype._runEditorScroll = function (viewModel, source, args) {
        ...
        EditorScrollImpl.prototype._computeDesiredScrollTop = function (viewModel, args) {
            if (args.unit === 1 /* Line */) {
    ...
    CoreNavigationCommands.ScrollLineUp = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_6.prototype.runCoreEditorCommand = function (viewModel, args) {
    ...
    CoreNavigationCommands.ScrollPageUp = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_7.prototype.runCoreEditorCommand = function (viewModel, args) {
            CoreNavigationCommands.EditorScroll._runEditorScroll(viewModel, args.source, {
                direction: 1 /* Up */,
                unit: 3 /* Page */,
                value: 1,
    ...
    CoreNavigationCommands.ScrollLineDown = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_8.prototype.runCoreEditorCommand = function (viewModel, args) {
            CoreNavigationCommands.EditorScroll._runEditorScroll(viewModel, args.source, {
                direction: 2 /* Down */,
                unit: 2 /* WrappedLine */,
                value: 1,
    ...
    CoreNavigationCommands.ScrollPageDown = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_9.prototype.runCoreEditorCommand = function (viewModel, args) {
            CoreNavigationCommands.EditorScroll._runEditorScroll(viewModel, args.source, {
                direction: 2 /* Down */,
                unit: 3 /* Page */,
                value: 1,
    ...
    var WordCommand = /** @class */ (function (_super) {
        ...
        WordCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, [
    ...
    CoreNavigationCommands.LastCursorWordSelect = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_10.prototype.runCoreEditorCommand = function (viewModel, args) {
            var lastAddedCursorIndex = viewModel.getLastAddedCursorIndex();
            var states = viewModel.getCursorStates();
            var newStates = states.slice(0);
    ...
    var LineCommand = /** @class */ (function (_super) {
        ...
        LineCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, [
    ...
    var LastCursorLineCommand = /** @class */ (function (_super) {
        ...
        LastCursorLineCommand.prototype.runCoreEditorCommand = function (viewModel, args) {
            var lastAddedCursorIndex = viewModel.getLastAddedCursorIndex();
            var states = viewModel.getCursorStates();
            var newStates = states.slice(0);
    ...
    CoreNavigationCommands.ExpandLineSelection = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_11.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
    ...
    CoreNavigationCommands.CancelSelection = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_12.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, [
    ...
    CoreNavigationCommands.RemoveSecondaryCursors = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_13.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, [
    ...
    CoreNavigationCommands.RevealLine = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_14.prototype.runCoreEditorCommand = function (viewModel, args) {
    ...
    CoreNavigationCommands.SelectAll = new /** @class */ (function (_super) {
        __extends(class_15, _super);
        function class_15() {
            return _super.call(this, SelectAllCommand) || this;
        }
        class_15.prototype.runDOMCommand = function () {
            if (isFirefox) {
        ...
        class_15.prototype.runEditorCommand = function (accessor, editor, args) {
            var viewModel = editor._getViewModel();
            if (!viewModel) {
                // the editor has no view => has no cursors
                return;
        ...
        class_15.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
    ...
    CoreNavigationCommands.SetSelection = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_16.prototype.runCoreEditorCommand = function (viewModel, args) {
            viewModel.model.pushStackElement();
            viewModel.setCursorStates(args.source, 3 /* Explicit */, [
...
(function (CoreEditingCommands) {
    ...
    CoreEditingCommands.LineBreakInsert = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_17.prototype.runCoreEditingCommand = function (editor, viewModel, args) {
            editor.pushUndoStop();
            editor.executeCommands(this.id, TypeOperations.lineBreakInsert(viewModel.cursorConfig, viewModel.model, viewModel.getCursorStates().map(function (s) { return s.modelState.selection; })));
        };
        return class_17;
    }(CoreEditingCommand)));
    CoreEditingCommands.Outdent = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_18.prototype.runCoreEditingCommand = function (editor, viewModel, args) {
            editor.pushUndoStop();
            editor.executeCommands(this.id, TypeOperations.outdent(viewModel.cursorConfig, viewModel.model, viewModel.getCursorStates().map(function (s) { return s.modelState.selection; })));
            editor.pushUndoStop();
        };
        return class_18;
    }(CoreEditingCommand)));
    CoreEditingCommands.Tab = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_19.prototype.runCoreEditingCommand = function (editor, viewModel, args) {
            editor.pushUndoStop();
            editor.executeCommands(this.id, TypeOperations.tab(viewModel.cursorConfig, viewModel.model, viewModel.getCursorStates().map(function (s) { return s.modelState.selection; })));
            editor.pushUndoStop();
        };
        return class_19;
    }(CoreEditingCommand)));
    CoreEditingCommands.DeleteLeft = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_20.prototype.runCoreEditingCommand = function (editor, viewModel, args) {
            var _a = __read(DeleteOperations.deleteLeft(viewModel.getPrevEditOperationType(), viewModel.cursorConfig, viewModel.model, viewModel.getCursorStates().map(function (s) { return s.modelState.selection; })), 2), shouldPushStackElementBefore = _a[0], commands = _a[1];
    ...
    CoreEditingCommands.DeleteRight = registerEditorCommand(new /** @class */ (function (_super) {
        ...
        class_21.prototype.runCoreEditingCommand = function (editor, viewModel, args) {
            var _a = __read(DeleteOperations.deleteRight(viewModel.getPrevEditOperationType(), viewModel.cursorConfig, viewModel.model, viewModel.getCursorStates().map(function (s) { return s.modelState.selection; })), 2), shouldPushStackElementBefore = _a[0], commands = _a[1];
            if (shouldPushStackElementBefore) {
                editor.pushUndoStop();
            }
            editor.executeCommands(this.id, commands);
    ...
    CoreEditingCommands.Undo = new /** @class */ (function (_super) {
        __extends(class_22, _super);
        function class_22() {
            return _super.call(this, UndoCommand) || this;
        }
        class_22.prototype.runDOMCommand = function () {
    ...
    CoreEditingCommands.Redo = new /** @class */ (function (_super) {
        __extends(class_23, _super);
        function class_23() {
            return _super.call(this, RedoCommand) || this;
        }
        class_23.prototype.runDOMCommand = function () {
