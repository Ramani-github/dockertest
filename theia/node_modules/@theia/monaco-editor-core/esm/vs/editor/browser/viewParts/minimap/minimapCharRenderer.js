...
var MinimapCharRenderer = /** @class */ (function () {
    ...
    MinimapCharRenderer.prototype.renderChar = function (target, dx, dy, chCode, color, backgroundColor, fontScale, useLighterFont, force1pxHeight) {
    ...
    MinimapCharRenderer.prototype.blockRenderChar = function (target, dx, dy, color, backgroundColor, useLighterFont, force1pxHeight) {
        var charWidth = 1 /* BASE_CHAR_WIDTH */ * this.scale;
        var charHeight = 2 /* BASE_CHAR_HEIGHT */ * this.scale;
        var renderHeight = (force1pxHeight ? 1 : charHeight);
        if (dx + charWidth > target.width || dy + renderHeight > target.height) {
