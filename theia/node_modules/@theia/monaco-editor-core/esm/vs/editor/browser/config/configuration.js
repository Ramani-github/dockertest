...
import { FontInfo, SERIALIZED_FONT_INFO_VERSION } from '../../common/config/fontInfo';
...
export function serializeFontInfo() {
    var fontInfo = CSSBasedConfiguration.INSTANCE.saveFontInfo();
...
var CSSBasedConfiguration = /** @class */ (function (_super) {
    ...
    CSSBasedConfiguration.prototype.restoreFontInfo = function (savedFontInfos) {
        var e_2, _a;
        try {
            // Take all the saved font info and insert them in the cache without the trusted flag.
            // The reason for this is that a font might have been installed on the OS in the meantime.
            for (var savedFontInfos_1 = __values(savedFontInfos), savedFontInfos_1_1 = savedFontInfos_1.next(); !savedFontInfos_1_1.done; savedFontInfos_1_1 = savedFontInfos_1.next()) {
                var savedFontInfo = savedFontInfos_1_1.value;
                if (savedFontInfo.version !== SERIALIZED_FONT_INFO_VERSION) {
                    // cannot use older version
                    continue;
                }
                var fontInfo = new FontInfo(savedFontInfo, false);
            ...
            try {
                if (savedFontInfos_1_1 && !savedFontInfos_1_1.done && (_a = savedFontInfos_1.return)) _a.call(savedFontInfos_1);
            }
    ...
    CSSBasedConfiguration._actualReadConfiguration = function (bareFontInfo) {
        ...
        var wsmiddotWidth = this.createRequest(String.fromCharCode(0x2E31), 0 /* Regular */, all, null);
...
var Configuration = /** @class */ (function (_super) {
    ...
    function Configuration(isSimpleWidget, options, referenceDomElement, accessibilityService) {
        ...
        _this._elementSizeObserver = _this._register(new ElementSizeObserver(referenceDomElement, options.dimension, function () { return _this._recomputeOptions(); }));
        _this._register(CSSBasedConfiguration.INSTANCE.onDidChange(function () { return _this._recomputeOptions(); }));
    ...
    Configuration.prototype.updatePixelRatio = function () {
        this._recomputeOptions();
    };
    Configuration._getExtraEditorClassName = function () {
        var extra = '';
