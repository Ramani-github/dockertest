...
var ViewLine = /** @class */ (function () {
    ...
    ViewLine.prototype.needsMonospaceFontCheck = function () {
        if (!this._renderedViewLine) {
            return false;
        }
        return (this._renderedViewLine instanceof FastRenderedViewLine);
    };
    ViewLine.prototype.monospaceAssumptionsAreValid = function () {
        if (!this._renderedViewLine) {
    ...
    ViewLine.prototype.onMonospaceAssumptionsInvalidated = function () {
...
var FastRenderedViewLine = /** @class */ (function () {
    ...
    FastRenderedViewLine.prototype.monospaceAssumptionsAreValid = function () {
        if (!this.domNode) {
            return monospaceAssumptionsAreValid;
        }
    ...
    FastRenderedViewLine.prototype.toSlowRenderedLine = function () {
