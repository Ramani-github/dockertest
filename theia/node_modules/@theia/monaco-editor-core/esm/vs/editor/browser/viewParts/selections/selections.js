...
var SelectionsOverlay = /** @class */ (function (_super) {
    ...
    function SelectionsOverlay(context) {
        ...
        _this._roundedSelection = options.get(85 /* roundedSelection */);
        _this._typicalHalfwidthCharacterWidth = options.get(38 /* fontInfo */).typicalHalfwidthCharacterWidth;
        _this._selections = [];
    ...
    SelectionsOverlay.prototype.prepareRender = function (ctx) {
        ...
        this._renderResult = output.map(function (_a) {
            var _b = __read(_a, 2), internalCorners = _b[0], restOfSelection = _b[1];
