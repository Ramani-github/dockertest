...
var LineDecoration = /** @class */ (function () {
    ...
    LineDecoration.extractWrapped = function (arr, startOffset, endOffset) {
        var e_1, _a;
        if (arr.length === 0) {
            return arr;
        }
    ...
    LineDecoration._typeCompare = function (a, b) {
        var ORDER = [2, 0, 1, 3];
...
var DecorationSegment = /** @class */ (function () {
    function DecorationSegment(startOffset, endOffset, className, metadata) {
...
var Stack = /** @class */ (function () {
    ...
    Stack._metadata = function (metadata) {
        var result = 0;
    ...
    Stack.prototype.insert = function (stopOffset, className, metadata) {
