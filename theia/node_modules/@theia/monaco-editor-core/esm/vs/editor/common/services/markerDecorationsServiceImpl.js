...
var MarkerDecorations = /** @class */ (function (_super) {
    ...
    function MarkerDecorations(model) {
        ...
        _this._register(toDisposable(function () {
            _this.model.deltaDecorations(__spreadArray([], __read(_this._markersData.keys())), []);
            _this._markersData.clear();
        }));
        return _this;
    }
    MarkerDecorations.prototype.update = function (markers, newDecorations) {
        var oldIds = __spreadArray([], __read(this._markersData.keys()));
...
var MarkerDecorationsService = /** @class */ (function (_super) {
    ...
    MarkerDecorationsService.prototype.getMarker = function (uri, decoration) {
        var markerDecorations = this._markerDecorations.get(MODEL_ID(uri));
        return markerDecorations ? (markerDecorations.getMarker(decoration) || null) : null;
    };
    MarkerDecorationsService.prototype.getLiveMarkers = function (uri) {
        var markerDecorations = this._markerDecorations.get(MODEL_ID(uri));
