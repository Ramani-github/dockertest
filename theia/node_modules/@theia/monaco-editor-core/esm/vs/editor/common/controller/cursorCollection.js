...
var CursorCollection = /** @class */ (function () {
    ...
    CursorCollection.prototype.getTopMostViewPosition = function () {
    ...
    CursorCollection.prototype.getBottomMostViewPosition = function () {
        var result = this.primaryCursor.viewState.position;
        for (var i = 0, len = this.secondaryCursors.length; i < len; i++) {
            var viewPosition = this.secondaryCursors[i].viewState.position;
    ...
    CursorCollection.prototype.normalize = function () {
        ...
        for (var sortedCursorIndex = 0; sortedCursorIndex < sortedCursors.length - 1; sortedCursorIndex++) {
            ...
            if (shouldMergeCursors) {
                ...
                try {
                    for (var sortedCursors_1 = (e_1 = void 0, __values(sortedCursors)), sortedCursors_1_1 = sortedCursors_1.next(); !sortedCursors_1_1.done; sortedCursors_1_1 = sortedCursors_1.next()) {
                        var sortedCursor = sortedCursors_1_1.value;
                    ...
                    try {
                        if (sortedCursors_1_1 && !sortedCursors_1_1.done && (_a = sortedCursors_1.return)) _a.call(sortedCursors_1);
                    }
