...
function resolveParsedTokenThemeRules(parsedThemeRules, customTokenColors) {
    ...
    try {
        ...
        for (var customTokenColors_1 = __values(customTokenColors), customTokenColors_1_1 = customTokenColors_1.next(); !customTokenColors_1_1.done; customTokenColors_1_1 = customTokenColors_1.next()) {
            var color = customTokenColors_1_1.value;
        ...
        try {
            if (customTokenColors_1_1 && !customTokenColors_1_1.done && (_a = customTokenColors_1.return)) _a.call(customTokenColors_1);
        }
