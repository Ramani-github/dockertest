...
var StandaloneCommandsQuickAccessProvider = /** @class */ (function (_super) {
    __extends(StandaloneCommandsQuickAccessProvider, _super);
    function StandaloneCommandsQuickAccessProvider(instantiationService, codeEditorService, keybindingService, commandService, telemetryService, notificationService) {
        var _this = _super.call(this, { showAlias: false }, instantiationService, keybindingService, commandService, telemetryService, notificationService) || this;
        _this.codeEditorService = codeEditorService;
        return _this;
    }
    Object.defineProperty(StandaloneCommandsQuickAccessProvider.prototype, "activeTextEditorControl", {
        get: function () { return withNullAsUndefined(this.codeEditorService.getFocusedCodeEditor()); },
        enumerable: false,
        configurable: true
    });
    StandaloneCommandsQuickAccessProvider.prototype.getCommandPicks = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getCodeEditorCommandPicks()];
            });
        });
    };
