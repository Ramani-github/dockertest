...
var MonarchClassicTokensCollector = /** @class */ (function () {
    ...
    MonarchClassicTokensCollector.prototype.nestedModeTokenize = function (embeddedModeLine, hasEOL, embeddedModeData, offsetDelta) {
...
var MonarchModernTokensCollector = /** @class */ (function () {
    ...
    MonarchModernTokensCollector.prototype.nestedModeTokenize = function (embeddedModeLine, hasEOL, embeddedModeData, offsetDelta) {
        var nestedModeId = embeddedModeData.modeId;
        var embeddedModeState = embeddedModeData.state;
        var nestedModeTokenizationSupport = modes.TokenizationRegistry.get(nestedModeId);
        if (!nestedModeTokenizationSupport) {
...
var MonarchTokenizer = /** @class */ (function () {
    ...
    MonarchTokenizer.prototype.tokenize = function (line, hasEOL, lineState, offsetDelta) {
    ...
    MonarchTokenizer.prototype.tokenize2 = function (line, hasEOL, lineState, offsetDelta) {
    ...
    MonarchTokenizer.prototype._tokenize = function (line, hasEOL, lineState, offsetDelta, collector) {
    ...
    MonarchTokenizer.prototype._nestedTokenize = function (line, hasEOL, lineState, offsetDelta, tokensCollector) {
    ...
    MonarchTokenizer.prototype._myTokenize = function (lineWithoutLF, hasEOL, lineState, offsetDelta, tokensCollector) {
        var e_2, _a;
        var _this = this;
        ...
        while (forceEvaluation || pos < lineLength) {
            ...
            if (groupMatching) {
                ...
                try {
                    for (var rules_2 = (e_2 = void 0, __values(rules)), rules_2_1 = rules_2.next(); !rules_2_1.done; rules_2_1 = rules_2.next()) {
                        var rule_1 = rules_2_1.value;
            ...
            var computeNewStateForEmbeddedMode = function (enteringEmbeddedMode) {
                // substitute language alias to known modes to support syntax highlighting
                var enteringEmbeddedModeId = _this._modeService.getModeIdForLanguageName(enteringEmbeddedMode);
                if (enteringEmbeddedModeId) {
                    enteringEmbeddedMode = enteringEmbeddedModeId;
                }
                var embeddedModeData = _this._getNestedEmbeddedModeData(enteringEmbeddedMode);
                if (pos < lineLength) {
                    // there is content from the embedded mode on this line
                    var restOfLine = lineWithoutLF.substr(pos);
                    return _this._nestedTokenize(restOfLine, hasEOL, MonarchLineStateFactory.create(stack, embeddedModeData), offsetDelta + pos, tokensCollector);
                }
                else {
