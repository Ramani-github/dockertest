    ...
    if (!action) {
        ...
        return {
            test: function (id, matches, state, eos) {
                var e_3, _a;
                try {
                    for (var cases_2 = __values(cases_1), cases_2_1 = cases_2.next(); !cases_2_1.done; cases_2_1 = cases_2.next()) {
                        var _case = cases_2_1.value;
...
export function compile(languageId, json) {
    ...
    var brackets = [];
    try {
        for (var _b = __values(json.brackets), _c = _b.next(); !_c.done; _c = _b.next()) {
            var el = _c.value;
            var desc = el;
