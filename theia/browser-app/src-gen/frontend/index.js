...
FrontendApplicationConfigProvider.set({
    "applicationName": "Killercoda Editor",
    "defaultTheme": "dark",
...
module.exports = nls.loadTranslations().then(() => {
    ...
    .then(function () { return Promise.resolve(require('theia-killercoda-extension/lib/browser/theia-killercoda-extension-frontend-module')).then(load) })
